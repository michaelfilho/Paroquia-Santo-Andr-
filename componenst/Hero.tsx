...
import { carouselAPI } from '../src/services/api';
...
export function Hero() {
  ...
  const slidesToRender = dynamicSlides.length > 0 ? dynamicSlides : defaultSlides;
  ...
  return (
    <section id="inicio" className="relative group h-screen flex items-center justify-center overflow-hidden bg-black">
              ...
              <div className="flex flex-col sm:flex-row gap-5 justify-center">
                {slide.primaryButton && (
                  <button
                    ...
                    className="group relative bg-gradient-to-r from-amber-600 to-amber-700 hover:from-amber-700 hover:to-amber-800 px-10 py-5 rounded-full font-semibold transition-all duration-300 hover:shadow-2xl hover:scale-105 overflow-hidden ring-1 ring-white/30"
                ...
                {slide.secondaryButton && (
                  <button
                    ...
                    className="group bg-white/10 backdrop-blur-md hover:bg-white/20 text-white px-10 py-5 rounded-full font-semibold transition-all duration-300 border border-white/30 hover:border-white/60 hover:shadow-xl hover:scale-105"
                  >
      ...
      {slidesToRender.length > 1 && (
        <>
          <div className="absolute z-30 inset-y-0 left-0 flex items-center px-2 md:px-4 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
            <button
              onClick={prevSlide}
              className="p-2 bg-transparent hover:bg-transparent text-white/50 hover:text-white transition-all hover:scale-110"
          ...
          <div className="absolute z-30 inset-y-0 right-0 flex items-center px-2 md:px-4 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
            <button
              onClick={nextSlide}
              className="p-2 bg-transparent hover:bg-transparent text-white/50 hover:text-white transition-all hover:scale-110"
